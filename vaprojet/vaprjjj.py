...
def load_data():
    ...
    ev_population = pd.read_csv("data/Electric_Vehicles_Population_Data.csv")
...
if page == "Overview":
    ...
    add_bg_from_local("images/ev-charging-stati.jpg")
    ...
    st.metric("Total States Analyzed", ev_population_filtered['State'].nunique())
